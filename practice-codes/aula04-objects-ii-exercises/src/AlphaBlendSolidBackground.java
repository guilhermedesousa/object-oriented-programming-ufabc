 ...
 */
public class AlphaBlendSolidBackground {
    
    private AlphaBlendSolidBackground() {
    ...
    public static void main(String[] args) {
        ...
        var background = new Color(ImageUtils.parseRgbValue(args[1]), ImageUtils.parseRgbValue(args[2]), ImageUtils.parseRgbValue(args[3]));

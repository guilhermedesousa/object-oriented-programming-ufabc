...
public class TestGenericQueue {
    ...
    public void testIsEmpty() {
        ...
        Assertions.assertTrue(defaultGenericQueue.isEmpty(), "Queue should be empty "
            + logQueue());
    }
    ...
    private void unexpectedQueueException(String type) {
        Assertions.fail(
            String.format("Should not throw exception on non-%s stack. %s",
                type, logQueue()));
    }
    ...
    private String logQueue() {
        return String.format("Size: %d Capacity: %d", defaultGenericQueue.size(),
            defaultGenericQueue.capacity());
    }

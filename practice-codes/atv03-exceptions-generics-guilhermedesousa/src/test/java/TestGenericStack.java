...
public class TestGenericStack {
    ...
    public void testStackIsFull() {
        ...
        for (int e : v) {
            Assertions.assertFalse(defaultGenericStack.isFull(),
                "Stack should not be full. " + logStack());
            try {
    ...
    public void testIsEmpty() {
        ...
        for (int e : v) {
            ...
            Assertions.assertFalse(defaultGenericStack.isEmpty(),
                "Stack should not be empty. " + logStack());
        }
    ...
    private String logStack() {
        return String.format("Size: %d Capacity: %d", defaultGenericStack.size(),
            defaultGenericStack.capacity());
    }
}
